...
g++ build/main.o build/app.o build/menu.o build/data_input.o build/visualizations.o build/statistical.o -o build/excel_c.exe -lbgi -lgdi32 -lcomdlg32 -luuid -loleaut32 -lole32
